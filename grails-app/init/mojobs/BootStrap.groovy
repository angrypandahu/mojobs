...
class BootStrap {
    ...
    def init = { servletContext ->
        if (Environment.current == Environment.DEVELOPMENT) {
            ...
            Requestmap.findOrCreateWhere(configAttribute: 'permitAll', url: '/error').save(flush: true)
            ...
            Requestmap.findOrCreateWhere(configAttribute: 'permitAll', url: '/shutdown').save(flush: true)
