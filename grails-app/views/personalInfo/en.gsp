...
<div class="panel panel-info">
    ...
    %{--</fieldset>--}%
    %{--</g:uploadForm>--}%
        <g:uploadForm name="command" role="form" action="save" method="POST">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="file" id="exampleInputFile" name="photoFile" accept="image/jpg,image/jpeg,image/png,image/gif,image/bmp"/>
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="firstName" class="form-control" id="firstNameId"
                       value="${command?.firstName}" required/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="lastName" class="form-control" id="lastNameId"
                       value="${command?.lastName}" required/>
            </div>

            <div class="checkbox">
                <input type="radio" name="gender" id="maleId" ${command?.gender ? 'checked' : ''}
                       value="true"/> <label
                    for="maleId">Male</label>
                <input type="radio" name="gender" id="femaleId" ${command?.gender ? '' : 'checked'}
                       value="false"/> <label
            ...
            <div class="form-group">
                ...
                <input type="email" id="emailId" value="${command?.email}" class="form-control" required>
            </div>
