...
<html>
    ...
    <body>
        ...
        <div id="show-workExperience" class="content scaffold-show" role="main">
            ...
            <f:display bean="workExperience" />
            <g:form resource="${this.workExperience}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.workExperience}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
