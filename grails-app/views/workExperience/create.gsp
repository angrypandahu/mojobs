<g:form action="save">
    ...
    <div class="form-group form-inline">
        ...
        <div class="checkbox">
            ...
            <label>
                <input type="checkbox" ${workExperience?.duration?.isPresent ? 'checked' : ''}
                       onclick="checkIsPresent(this)"/> Present
    ...
    <div class="form-group">
        <button type="button" class="btn btn-default" onclick="cancelCreateWorkExperience()">
            cancel
        </button>
